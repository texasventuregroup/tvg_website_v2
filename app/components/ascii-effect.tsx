  ...
  constructor(options: AsciiEffectOptions) {
    ...
    super("AsciiEffect", fragmentShader, {
      ...
      uniforms: new Map<string, Uniform<any>>([
        ...
        ["scanlineIntensity", new Uniform((postfx.scanlineIntensity as number) || 0)],
        ["scanlineCount", new Uniform((postfx.scanlineCount as number) || 200)],
        ["targetFPS", new Uniform((postfx.targetFPS as number) || 0)],
        ["jitterIntensity", new Uniform((postfx.jitterIntensity as number) || 0)],
        ["jitterSpeed", new Uniform((postfx.jitterSpeed as number) || 1)],
        ["mouseGlowEnabled", new Uniform((postfx.mouseGlowEnabled as boolean) || false)],
        ["mouseGlowRadius", new Uniform((postfx.mouseGlowRadius as number) || 200)],
        ["mouseGlowIntensity", new Uniform((postfx.mouseGlowIntensity as number) || 1.5)],
        ["vignetteIntensity", new Uniform((postfx.vignetteIntensity as number) || 0)],
        ["vignetteRadius", new Uniform((postfx.vignetteRadius as number) || 0.8)],
        ["colorPalette", new Uniform((postfx.colorPalette as number) || 0)],
        ["curvature", new Uniform((postfx.curvature as number) || 0)],
        ["aberrationStrength", new Uniform((postfx.aberrationStrength as number) || 0)],
        ["noiseIntensity", new Uniform((postfx.noiseIntensity as number) || 0)],
        ["noiseScale", new Uniform((postfx.noiseScale as number) || 1)],
        ["noiseSpeed", new Uniform((postfx.noiseSpeed as number) || 1)],
        ["waveAmplitude", new Uniform((postfx.waveAmplitude as number) || 0)],
        ["waveFrequency", new Uniform((postfx.waveFrequency as number) || 10)],
        ["waveSpeed", new Uniform((postfx.waveSpeed as number) || 1)],
        ["glitchIntensity", new Uniform((postfx.glitchIntensity as number) || 0)],
        ["glitchFrequency", new Uniform((postfx.glitchFrequency as number) || 0)],
        ["brightnessAdjust", new Uniform((postfx.brightnessAdjust as number) || 0)],
        ["contrastAdjust", new Uniform((postfx.contrastAdjust as number) || 1)],
      ]),
    })
