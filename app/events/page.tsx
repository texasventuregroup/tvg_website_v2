...
const events: Event[] = [
  ...
  { title: 'TVG x a16z Crypto', date: 'Spring 2025', image: '/images/events/chris_lyons.jpeg', description: 'Fireside chat with Chris Lyons, a General Partner at a16z leading the firm\'s crypto investment efforts, shared insights about web3\'s evolution and early-stage investing in crypto', year: 'S25' },
  ...
  { title: 'TVG x TXB x Quai Network: Demo Day', date: 'Spring 2025', image: '/images/events/txb_tvg_demo_day.jpeg', description: 'TVG and TXB hosted UT Austin\'s top founders for an evening of decentralized AI discussions and live startup pitches at the DeAI office. Founders competed for over $2K in cash prizes, followed by networking with peers and judges. Sponsored by Quai Network.', year: 'S25' },
  ...
  { title: 'TVG x CVP x SVS: Student VC Mixer', date: 'Spring 2025', image: '/images/events/tvg_vc_mixer.jpeg', description: 'Co-hosted with Columbia Venture Partners, NYU Strategic Venture Society, and Ocean Ventures, this happy hour gave students in the NYC area involved in the venture capital and startup ecosystem a perfect opportunity to network, share ideas, and enjoy light bites in a causal setting.', year: 'S25' },
  { title: 'TVG x New York City', date: 'Spring 2025', image: '/images/events/tvg_nyc_flyer.jpeg', description: 'From January 7th-8th, TVG ventured to New York City and connected with leading venture capital firms,  including Insight Partners, NEA, and Bessemer Venture Partners, as well as innovators like Adam Dell. We enjoyed diving deeper into the world of VC and entrepreneurship in NYC.', year: 'S25' },

  {
    title: 'TVG x TREL x Saronic',
    date: 'Fall 2024',
    image: '/images/events/saronic_f24.jpeg',
    description: (
      <>
        <b>Texas Venture Group (TVG)</b> and <b>Texas Rocket Engineering Lab (TREL)</b> are pleased
        to welcome <b>Saronic</b> to UT Austin for an exclusive informational and recruitment
        event. The event will be hosted in <b>Robert B. Rowling Hall (Room 4.402)</b>. We encourage
        attendees to visit{' '}
        <a href="https://saronic.com" target="_blank" rel="noopener noreferrer">
          saronic.com
        </a>{' '}
        and conduct some preliminary research on the company prior to the event.
        <br />
        <br />
        <b>Saronic</b>, an Austin-based startup that is developing autonomous ships for defense, has
        recently raised <b>$55 million</b> in a Series A funding round from <b>8VC</b>, <b>a16z</b>,{' '}
        <b>Lightspeed Venture Partners</b>, <b>Point72 Ventures</b>, <b>Silent Ventures</b>, and
        others. <b>Saronic</b> was co-founded by <b>Ex-Navy Seal Dino Mavrookas</b>, <b>Ex-Lead
        Perception Engineer at Anduril</b>, <b>Vibhav A</b>, and others.
      </>
    ),
    year: 'F24',
  },
  {
    title: 'TVG x LEC x Base Power Company',
    date: 'Fall 2024',
    image: '/images/events/base_tvg_24.jpeg',
    description: (
      <>
        <b>Texas Venture Group&nbsp;(TVG)</b> and <b>Longhorn Energy Club&nbsp;(LEC)</b> are
        pleased to welcome <b>Base Power Company</b> to UT Austin for an exclusive informational
        event. The event will be hosted in <b>Robert B. Rowling Hall&nbsp;(Room&nbsp;5.408)</b>. We
        encourage attendees to visit{' '}
        <a href="https://www.basepowercompany.com/" target="_blank" rel="noopener noreferrer">
  ...
  { title: 'TVG x Foundational Capital', date: 'Fall 2023', image: '/images/events/tvg_foundation_capital.jpeg', description: 'TVG hosted a panel discussion with Foundation Capital, inviting speakers building in defense tech, robotics, and the VR software sectors.', year: 'F23' }
];
