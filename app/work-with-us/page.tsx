...
function RadialCapabilities() {
    ...
    return (
        <div className="relative w-full max-w-[700px] aspect-square mx-auto hidden lg:block">
            ...
            {activeIndex !== null && (
                <div className={`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-[100] w-[90vw] max-w-[420px] bg-[#016F4E] text-white rounded-3xl p-8 lg:p-10 transition-all duration-500 ease-out ${showDetail ? 'opacity-100 scale-100' : 'opacity-0 scale-75'
                    }`}>
            ...
            {services.map((svc, i) => {
                ...
                const normalX = Math.round(Math.cos(rad) * radius * 1000) / 1000;
                const normalY = Math.round(Math.sin(rad) * radius * 1000) / 1000;

                const x = converged ? 0 : normalX;
                const y = converged ? 0 : normalY;
                ...
                return (
                    <div key={svc.number}>
                        ...
                        <div
                            ...
                            style={{
                                top: `calc(50% + ${Math.round(normalY * 1.35 * 1000) / 1000}px)`,
                                left: `calc(50% + ${Math.round(normalX * 1.35 * 1000) / 1000}px)`,
                                width: '220px',
                                textAlign: 'center',
                                zIndex: 100,
...
export default function WorkWithUs() {
    return (
        <main className="w-full min-h-screen bg-[#fcf7f0] text-[#082820]">
            ...
            <section className="relative pt-32 pb-20 min-h-[60vh] flex items-center overflow-hidden bg-[#fcf7f0]">
                <div className="container mx-auto px-6 relative z-10">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        ...
                        {/* Video Content */}
                        <div className="relative h-[260px] sm:h-[360px] lg:h-[500px] w-full rounded-2xl overflow-hidden shadow-2xl border border-[#082820]/10 group bg-[#fcf7f0]">
            ...
            <section className="py-16 md:py-32 lg:py-40 bg-[#f8f3eb] relative overflow-hidden">
                {/* Dot grid background */}
                <div
            ...
            {/* ===== WORK SAMPLE ===== */}
            <section className="border-t border-[#082820]/10 py-16 md:py-20">
                <div className="container mx-auto px-6 lg:px-12 flex flex-col sm:flex-row items-center justify-between gap-8">
                    <Reveal>
                        <div>
                            <p className="font-mono text-[11px] font-bold tracking-[0.2em] text-[#016F4E] uppercase mb-2">Portfolio</p>
                            <h2 className="text-3xl md:text-4xl font-semibold tracking-tight">See our work</h2>
                            <p className="text-[#082820]/60 mt-3 max-w-md">
                                Reach out to get a sample of past deliverables — market maps, memos, and technical builds.
                            </p>
                        </div>
                    </Reveal>
                    <Reveal delay={100}>
